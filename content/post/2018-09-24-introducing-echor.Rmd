...
Thankfully, ECHO provides web access through "GET" and REST services to provide some level of automated and reproducible data access. I recently wrote the [`echor`](https://mps9506.github.io/echor/index.html) package to provide access to these service in R. This was my first attempt at developing an R package **and** my first attempt at utilizing data APIs in a programatic way.`r tufte::margin_note("![https://media.giphy.com/media/elFj7gYCIxVxC/giphy.gif](https://media.giphy.com/media/elFj7gYCIxVxC/giphy.gif)")`
